...
def overfit_model(train_generator, no_train_instances, test_generator, no_test_instances):
    ...
    model.fit_generator(train_generator, no_train_instances, nb_epoch=1, verbose=1, callbacks=[], validation_data=test_generator)

    score = model.evaluate_generator(test_generator, no_test_instances)
    # print('test loss', score)
    print('Test score:', score[0])
    print('Test accuracy:', score[1])
